...
type ModalStateType = { modalOpen: boolean };
...
type OpenModalAction = { type: "OPEN_MODAL" };
type Action = CloseModalAction | OpenModalAction;

const initialState: ModalStateType = { modalOpen: false };
...
function ModalProvider({ children }: ModalProviderProps) {
  ...
  const ctxValue: ModalContextValue = { modalOpen, closeModal, openModal };
