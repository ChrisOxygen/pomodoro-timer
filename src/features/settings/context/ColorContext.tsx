...
type SetThemeAction = { type: "SET_THEME"; payload: string };
type SetSelectedColorAction = { type: "SET_SELECTED_COLOR"; payload: string };
type Action = SetThemeAction | SetSelectedColorAction;

const initialState: ColorStateType = {
  activeColor: localStorage.getItem("color") ?? "#F87070",
  selectedColor: "",
};
