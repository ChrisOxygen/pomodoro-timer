...
type FontProviderProps = { children: ReactNode };

type SetFontAction = { type: "SET_FONT"; payload: string };
type SetSelectedFontAction = { type: "SET_SELECTED_FONT"; payload: string };
